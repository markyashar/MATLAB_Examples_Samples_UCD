...
% result_cs = [0.00:0.01:2.00];
% result_as=normrnd(a,sigmaa,[1 1000]);
% result_bs=normrnd(b,sigmab,[1 1000]);
% result_cs=normrnd(c,sigmac,[1 1000]);
...
% result_as=normrnd(a,sigmaa,[1 500]);
% result_bs=normrnd(b,sigmab,[1 500]);
% result_cs=normrnd(c,sigmac,[1 500]);
% result_as = linspace(min(result_as),max(result_as),601);
% result_bs = linspace(min(result_bs),max(result_bs),601);
result_as = [1.1666:0.00002:1.1722];
result_bs = [1.6186:0.00002:1.6242];
result_cs = [1.1756:0.00002:1.1812];
% chisquared2d= Chisq2(a,b,c,as,bs,cs,sigmax,sigmay,sigmaz);
% chisquared3d= Chisq3(a,b,c,as,bs,cs,sigmax,sigmay,sigmaz);
% cl_linspace = gammainc(chisquared2d/2,1);
% cl_linspace_all = gammainc(chisquared3d/2,3/2);
...
fprintf('                                         \n')
fprintf('                                         \n')
fprintf('result_as result_bs result_cs cl(A) cl(B) cl(A)-cl(B) chi^2(A) chi^2(B) chi^2(B)-chi^2(A) chi^2(A)_red chi^2(B)_red chi^2(B)_red-chi^2(A)_red\n')
[result_as', result_bs', result_cs', cl_data',cl_data_all',cl_data_all'-cl_data',chisquared2d_data',chisquared3d_data',chisquared3d_data'-chisquared2d_data',chisquared2d_data'/2,chisquared3d_data'/3,chisquared3d_data'/3-chisquared2d_data'/2]
fprintf('                                         \n')
fprintf('                                         \n')
fprintf('mean(cl(B)-cl(A))   mean(chi^2(B)-chi^2(A)))   mean(chi^2(B)_red-chi^2(A)_red\n')
[mean(abs(cl_data_all'-cl_data')), mean(abs(chisquared3d_data'-chisquared2d_data')), mean(abs(chisquared3d_data'/3-chisquared2d_data'/2))]
figure(1)
plot3(result_as,result_bs,chisquared3d_data,'O');
% % % zdir = [0 0 1];
% % % center = [10 10 0];
% % % rotate(h,zdir,45,center)
xlabel('a_{sim}'); ylabel('b_{sim}'); zlabel('\chi^2 (B)')
title(['\chi^2 (B) vs. a_{sim} & b_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqB_as_bs;
% 
% 
figure(2)
plot3(result_as,result_bs,chisquared2d_data,'O');
%xlabel('a_{sim}'); ylabel('b_{sim}'); zlabel('\chi^2 (A)')
title(['\chi^2 (A) vs. a_{sim} & b_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqA_as_bs;
  
figure(3)
plot3(result_as,result_bs,abs(chisquared3d_data-chisquared2d_data),'O');
xlabel('a_{sim}'); ylabel('b_{sim}'); zlabel('\chi^2 (B) - \chi^2 (A)')
title(['\chi^2(B)-\chi^2(A) vs. a_{data} & b_{data} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqB-chisqA_as_bs;
% 
%  
figure(4)
plot3(result_as,result_cs,chisquared3d_data,'O');
xlabel('a_{sim}'); ylabel('c_{sim}'); zlabel('\chi^2 (B)')
title(['\chi^2 (B) vs. a_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
%       % ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
% % print -deps plot3_chisqB_as_cs_data;
print -deps plot3_chisqB_as_cs
% 
figure(5)
plot3(result_as,result_cs,chisquared2d_data,'O');
xlabel('a_{sim}'); ylabel('c_{sim}'); zlabel('\chi^2 (A)')
title(['\chi^2 (A) vs. a_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqA_as_cs;
% % 
figure(6)
plot3(result_as,result_cs,abs(chisquared3d_data-chisquared2d_data),'O');
xlabel('a_{sim}'); ylabel('c_{sim}'); zlabel('\chi^2(B) - \chi^2(A)')
title(['\chi^2 (B) - \chi^2(A) vs. a_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
%       % ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
% % print -deps plot3_chisqB-chisqA_as_cs_data;
print -deps plot3_chisqB-chisqA_as_cs;
% % 
% % 
figure(7)
plot3(result_bs,result_cs,chisquared3d_data,'O');
xlabel('b_{sim}'); ylabel('c_{sim}'); zlabel('\chi^2 (B)')
title(['\chi^2 (B) vs. b_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqB_bs_cs;
% 
%  
figure(8)
plot3(result_bs,result_cs,chisquared2d_data,'O');
xlabel('b_{sim}'); ylabel('c_{sim}'); zlabel('\chi^2 (A)')
title(['\chi^2 (A) vs. b_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqA_bs_cs;
% 
%  
figure(9)
plot3(result_bs,result_cs,abs(chisquared3d_data-chisquared2d_data),'O');
xlabel('b_{sim}'); ylabel('c_{sim}'); zlabel('\chi^2(B)-\chi^2(A)')
title(['\chi^2 (B) vs. b_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqB-chisqA_bs_cs;
% % 
% % 
figure(10)
plot3(result_as,result_bs,cl_data_all,'O');
xlabel('a_{sim}'); ylabel('b_{sim}'); zlabel('C.L.(B)')
title(['C.L.(B) vs. a_{sim} & b_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CL_B_as_bs;
% 
figure(11)
plot3(result_as,result_bs,cl_data,'O');
xlabel('a_{sim}'); ylabel('b_{sim}'); zlabel('C.L.(A)')
title(['C.L.(A) vs. a_{data} & b_{data} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CL_A_as_bs;
% 
figure(12)
plot3(result_as,result_bs,cl_data_all-cl_data,'O');
xlabel('a_{sim}'); ylabel('b_{sim}'); zlabel('C.L.(B)-C.L.(A)')
title(['C.L.(B)-C.L.(A) vs. a_{data} & b_{data} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CLB-CLA_as_bs;
%  
figure(13)
plot3(result_as,result_cs,cl_data_all,'O');
xlabel('a_{sim}'); ylabel('c_{sim}'); zlabel('C.L.(B)')
title(['C.L.(B) vs. a_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CL_B_as_cs;
% 
figure(14)
plot3(result_as,result_cs,cl_data,'O');
xlabel('a_{sim}'); ylabel('c_{sim}'); zlabel('C.L.(A)')
title(['C.L.(A) vs. a_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CL_A_as_cs;
%  
figure(15)
plot3(result_as,result_cs,cl_data_all-cl_data,'O');
xlabel('a_{sim}'); ylabel('c_{sim}'); zlabel('C.L.(B)-C.L.(A)')
title(['C.L.(B)-C.L.(A) vs. a_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CLB-CLA_as_cs;
%  
%  
figure(16)
plot3(result_bs,result_cs,cl_data_all,'O');
xlabel('b_{sim}'); ylabel('c_{sim}'); zlabel('C.L.(B)')
title(['C.L.(B) vs. b_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CL_B_bs_cs;
%  
%  
figure(17)
plot3(result_bs,result_cs,cl_data,'O');
xlabel('b_{sim}'); ylabel('c_{sim}'); zlabel('C.L.(A)')
title(['C.L.(A) vs. b_{sim} & c_{sim} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CL_A_bs_cs;
% 
figure(18)
plot3(result_bs,result_cs,cl_data_all-cl_data,'O');
xlabel('b_{sim}'); ylabel('c_{sim}'); zlabel('C.L.(B)-C.L.(A)')
title(['C.L.(B)-C.L.(A) vs. b_{data} & c_{data} for case of a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CLB-CLA_bs_cs;
% % 
figure(19)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqB-chisqA_chisqA_chisqB_abc_var;
% 
figure(20)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_chisqBred-chisqAred_chisqAred_chisqBred_abc_var;
% 
figure(21)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot3_CLB-CLA_CLA_CLB_abc_var;
% 
%  
figure(22)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_as_bs_cs_CLA_chisqA;
% 
figure(23)
% % axis([-10.0 1.0e5 0.0 2.0]);
plot(result_cs,chisquared2d_data,'O')
% % axis([-10.0 1.0e5 0.0 2.0])
% % xlim([-10.0 max(chisquared2d_data)])
% % ylim([0 2])
xlabel('c_{sim}'); ylabel('\chi^2 (A)')
title(['\chi^2 (A) vs. c_{sim}, a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_cs_var_chisqA;
% 
figure(24)
% % axis([-10.0 1.0e5 0.0 2.0]);
plot(result_cs, chisquared3d_data,'O')
% % axis([-10.0 1.0e5 0.0 2.0])
% % xlim([-10.0 max(chisquared2d_data)])
% % ylim([0 2])
% xlabel('c_{sim}'); ylabel('\chi^2 (B)')
title(['\chi^2 (B) vs c_{sim} , a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
       % ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_cs_var_chisqB;
% 
% 
figure(25)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_CLB_chisqB_abc_var;
%  
figure(26)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_CLB_CLA;
% 
figure(27)
% % axis([-10.0 1.0e5 0.0 2.0]);
plot(result_cs, cl_data, 'O')
% % axis([-10.0 1.0e5 0.0 2.0])
% % xlim([-10.0 max(chisquared2d_data)])
% % ylim([0 2])
xlabel('c_{sim}'); ylabel('C.L.(A)')
title(['C.L.(A) vs. c_{sim}, a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_cs_CLA_abc_var;
% 
% 
figure(28)
% % axis([-10.0 1.0e5 0.0 2.0]);
plot(result_cs,chisquared3d_data-chisquared2d_data,'O')
% % axis([-10.0 1.0e5 0.0 2.0])
% % xlim([-10.0 max(chisquared2d_data)])
% % ylim([0 2])
xlabel('c_{sim}'); ylabel('\chi^2(B) - \chi^2(A)')
title(['\chi^2(B) - \chi^2(A) vs. c_{sim}, a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_cs_chisqB-chisqA_abc_var;
% 
figure(29)
% % axis([-10.0 1.0e5 0.0 2.0]);
plot(result_cs,cl_data_all-cl_data,'O')
% % axis([-10.0 1.0e5 0.0 2.0])
% % xlim([-10.0 max(chisquared2d_data)])
% % ylim([0 2])
xlabel('c_{sim}'); ylabel('C.L.(B) - C.L.(A)')
title(['C.L.(B) - C.L.(A) vs. c_{sim}, a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_cs_CLB-CLA_abc_var;
% 
figure(30)
% % axis([-10.0 1.0e5 0.0 2.0]);
plot(result_cs,cl_data_all,'O')
% % axis([-10.0 1.0e5 0.0 2.0])
% % xlim([-10.0 max(chisquared2d_data)])
% % ylim([0 2])
xlabel('c_{sim}'); ylabel('C.L.(B)')
title(['C.L.(B) vs. c_{sim}, a = ',num2str(a),' ,b =',num2str(b),',c =',num2str(c),...
       ', \sigma_{x} =',num2str(sigmax),', \sigma_{y} =',num2str(sigmay),', \sigma_{z} =',num2str(sigmaz)]);
%       ', a_{sim} = ',num2str(as),', b_{sim} = ',num2str(bs)]);
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_cs_CLB_abc_var;
% 
% 
figure(31)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_CLB-CLA_CLA_abc_var;
% 
figure(32)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_CLB-CLA_CLB_abc_var;
%  
%  
figure(33)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_chisqB_chisqA_abc_var;
% 
figure(34)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_chisqB-chisqA_chisqA_abc_var;
% 
figure(35)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_chisqB-chisqA_chisqB_abc_var;
% 
%  
figure(36)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_chi2redA_chi2redB_abc_var;
% 
figure(37)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_chisqBred-chisqAred_vs_chisqAred_abc_var;
% 
figure(38)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
grid on
print -deps plot_chi2Bred-chi2Ared_vs_chi2Bred_abc_var;
% 
% % figure(33)
...
% save cl_data
% save cl_data_all
% save chisquared2d_data
% save chisquared3d_data
% save result_as
% save result_bs
% save result_cs
% 
