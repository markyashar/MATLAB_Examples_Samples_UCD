...
% result_as=normrnd(a,sigmaa,[1 1000]);
% result_bs=normrnd(b,sigmab,[1 1000]);
% result_cs=normrnd(c,sigmac,[1 201]);
result_as = linspace(min(result_as),max(result_as),576);
result_bs = linspace(min(result_bs),max(result_bs),576);
result_cs = [1.1764:0.00002:1.1879];
% chisquared2d= Chisq2(a,b,c,as,bs,cs,sigmax,sigmay,sigmaz);
% chisquared3d= Chisq3(a,b,c,as,bs,cs,sigmax,sigmay,sigmaz);
% cl_linspace = gammainc(chisquared2d/2,1);
% cl_linspace_all = gammainc(chisquared3d/2,3/2);
...
% grid on
% print -deps plot3_chisqB_as_const_bs_const;
% 
% 
% figure(2)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_chisqA_as_const_bs_const;
%  
% figure(3)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_chisqB-chisqA_as_const_bs_const;
% 
%  
% figure(4)
...
% print -deps plot3_chisqB_as_const_cs
% 
% figure(5)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_chisqA_as_const_cs;
% % 
% figure(6)
...
% print -deps plot3_chisqB-chisqA_as_const_cs;
% % 
% % 
% figure(7)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_chisqB_bs_const_cs_data;
% 
%  
% figure(8)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_chisqA_bs_const_cs;
% 
%  
% figure(9)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_chisqB-chisqA_bs_const_cs;
% % 
% % 
% figure(10)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CL_B_as_const_bs_const;
% 
% figure(11)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CL_A_as_const_bs_const;
% 
% figure(12)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CLB-CLA_as_const_bs_const;
%  
% figure(13)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CL_B_as_const_cs;
% 
% figure(14)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CL_A_as_const_cs;
%  
% figure(15)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CLB-CLA_as_const_cs;
%  
%  
% figure(16)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CL_B_bs_const_cs;
%  
%  
% figure(17)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CL_A_bs_const_cs;
% 
% figure(18)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CLB-CLA_bs_const_cs;
% % 
% figure(19)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_chisqB-chisqA_chisqA_chisqB;
% 
% figure(20)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_chisqBred-chisqAred_chisqAred_chisqBred;
% 
% figure(21)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot3_CLB-CLA_CLA_CLB;
% 
%  
% figure(22)
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot_as_bs_CLA_chisqA;
% 
% figure(23)
% % axis([-10.0 1.0e5 0.0 2.0]);
...
% %      ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot_cs_chisqB-chisqA;
% 
% figure(29)
% % axis([-10.0 1.0e5 0.0 2.0]);
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot_chisqB-chisqA_chisqA;
% 
% figure(35)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot_chisqB-chisqA_chisqB;
% 
%  
% figure(36)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot_chisqBred-chisqAred_vs_chisqAred;
% 
% figure(38)
...
% %     ', \sigma_{a} =',num2str(sigmaa),', \sigma_{b} =',num2str(sigmab),', \sigma_{c} =',num2str(sigmac)]);
% grid on
% print -deps plot_chi2Bred-chi2Ared_vs_chi2Bred;
% 
% % figure(33)
